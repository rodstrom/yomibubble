...
ArtifexLoader::ArtifexLoader(Root *root, SceneManager *scenemgr, SceneNode *camnode, Camera *camera, string zonepath, GameObjectManager *game_object_manager)
{
	mZonePath = zonepath;
	...
	mDBManager = new DBManager(this, game_object_manager);	
