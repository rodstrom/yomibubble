...
public:
	...
	void Init(Ogre::RenderWindow* render_window, MessageSystem* message_system, FadeInFadeOut* fade) { m_render_window = render_window; m_message_system = message_system; m_fade = fade; }
