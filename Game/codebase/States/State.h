...
public:
	...
	void Init(Ogre::RenderWindow* render_window, MessageSystem* message_system, SoundManager* sound_manager, FadeInFadeOut* fade) { m_render_window = render_window; m_message_system = message_system; m_sound_manager = sound_manager; m_fade = fade;}
