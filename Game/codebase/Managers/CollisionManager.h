...
private:
	...
	void QuestTottQuestItem(GameObject* quest_tott, GameObject* item);
	void QuestItemQuestTott(GameObject* item, GameObject* quest_tott) { QuestTottQuestItem(quest_tott, item); }
